...
const ManageImagesContent = ({items, currentItem, handleDelete, handleClick}) => {

    return(
        <Container>
            <Row>
                <Col>
                  <ListContainer items={items} currentItem={currentItem} handleDelete={handleDelete} handleClick={handleClick}/>
                </Col>
                <Col xs={6} md={4}>
